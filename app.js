...
// important: express.urlencoded() and express.json() don't parse the body for know if execute, instead they look at the headers of the incoming 
// requests that contain information about the encoding type (urlencoded or JSON) of the request.
